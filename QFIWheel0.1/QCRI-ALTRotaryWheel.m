...
@implementation QCRI_ALTRotaryWheel
...
- (void) drawWheel {
    ...
    [self.delegate wheelDidChangeValue:[self getCloveName:currentSector]];
...
- (void) buildClovesEven {
    ...
    for (int i = 0; i < numberOfSections; i++) {
        ...
        QCRI_ALTSector *clove = [[QCRI_ALTSector alloc] init];
        clove.midValue = mid;
...
- (BOOL)beginTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    UIImageView *im = [self getCloveByValue:currentSector];
    im.alpha = minAlphavalue;
...
- (void)endTrackingWithTouch:(UITouch*)touch withEvent:(UIEvent*)event
{
    ...
    for (QCRI_ALTSector *c in sectors) {
